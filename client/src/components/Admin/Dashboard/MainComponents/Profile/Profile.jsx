...
const AdminProfile = () => (
  <div className="container flex justify-center items-center">
    <div className="flex flex-col bg-white justify-center items-center mt-10 py-6 sm:w-1/3 text-center">
      <img className="w-20 h-20 rounded-full inline-flex items-center justify-center" src="https://adminlte.io/themes/v3/dist/img/user2-160x160.jpg" alt="Admin Profile" />
      <div className="flex flex-col items-center text-center justify-center">
        <h2 className="font-medium title-font mt-4 text-gray-900 text-2xl">Admin Name</h2>
        <div className="font-normal title-font text-gray-600">Email: abc@gmail.com</div>
