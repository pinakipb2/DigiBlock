...
import { Tag, TagLabel, WrapItem, Wrap } from '@chakra-ui/react';

const Table = ({ tableData, pagesVisited, dataPerPage, issuer }) => {
      ...
      <td className="flex justify-center items-center">
        <Wrap align="center" m={2}>
          {val.docType.map((doc, ind) => (
            ...
            <WrapItem key={ind}>
              <Tag size="lg" borderRadius="full" variant="solid" bg="red.700">
