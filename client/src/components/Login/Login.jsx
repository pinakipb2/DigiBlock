  ...
  return (
    <div className="flex flex-col justify-center items-center w-1/2 bg-white rounded-2xl" style={{ height: '35rem' }}>
      ...
      <>
        ...
        <ConnectWallet />
        <button type="button" className="bg-blue-700 rounded-md px-3 py-2 text-white w-32 h-12 text-center text-lg font-bold hover:bg-blue-500 select-none mb-10" onClick={() => stepTwo()}>Next</button>
      </>
      )}
      {currentFormStep === 2 && (
      <>
        <div className="flex flex-col justify-center w-1/2 py-10">
          <div className="flex items-center justify-center w-full">
            <div className="relative bg-green-600 rounded-full h-8 w-10 font-bold text-white text-center flex items-center justify-center">
        ...
        <div className="flex justify-between items-center w-2/5 pb-10">
          <button type="button" className="bg-blue-700 rounded-md px-3 py-2 text-white w-32 h-12 text-center text-lg font-bold hover:bg-blue-500 select-none" onClick={() => stepOne()}>Back</button>
