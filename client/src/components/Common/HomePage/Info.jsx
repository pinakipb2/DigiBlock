...
const Info = () => (
  <div className="text-center items-center bg-blue1 pt-20 pb-20 text-white">
    <h1 className="font-bold text-3xl mb-6 font-roboto">How It Works?</h1>
    <div className="flex justify-evenly items-center mb-6">
      <div className="flex flex-col justify-center items-center">
        ...
        <h1 className="text-lg title-font font-bold my-3 font-ubuntu">Register Yourself</h1>
      </div>
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <h1 className="text-lg title-font font-bold my-3 font-ubuntu">Search Documents</h1>
      </div>
      <i className="fas fa-arrow-right text-3xl" />
      <div className="flex flex-col justify-center items-center">
        <div className="rounded-full p-6 bg-gray-50 h-36 w-36 flex justify-center items-center shadow-2xl">
